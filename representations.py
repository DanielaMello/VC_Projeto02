#Definição de funções para representar palavras em formato vetorial
#com o objetivo de serem usadas em problemas relacionados ao
#reconhecimento de palavras em documentos manuscritos.
import numpy as np
