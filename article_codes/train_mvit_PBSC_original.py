#Treinamento de rede neural para tarefas de reconhecimento de
#palavras manuscritas, usando uma arquitetura de rede neural convolucional
#moderna (MobileViT) e otimizando os hiperparâmetros durante o processo de treinamento.
import os
